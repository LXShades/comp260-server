...
class Game:
    def __init__(self):
        ...
        # Create a client for the local test player (testing only). Comment this out when a player-less server is desired
    ...
    def create_local_client(self):
        ...
        threading.Thread(target=self.run_local_client, daemon=True).start()
